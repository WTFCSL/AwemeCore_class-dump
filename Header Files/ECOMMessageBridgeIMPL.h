...
@class NSString, ECOMGetUserMessageTrigger;

@interface ECOMMessageBridgeIMPL : NSObject <ECOMTIMStartUpTaskProtocol> {
    ECOMGetUserMessageTrigger *_getUserMessageTrigger;
}

@property (retain, nonatomic) ECOMGetUserMessageTrigger *getUserMessageTrigger;
