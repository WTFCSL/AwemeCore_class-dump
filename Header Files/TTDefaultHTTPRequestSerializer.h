...
- (id)lucky_buildParamsWithParams:(id)arg0 requestCommonParams:(id)arg1;
- (id)lucky_buildCommonParamsWithCommonParams:(id)arg0;
- (void)lucky_trackWithURL:(id)arg0 commonParams:(id)arg1;
- (id)_transferedURL:(id)arg0;
- (void)buildRequestHeaders:(id)arg0;
- (void)applyCookieHeader:(id)arg0;
