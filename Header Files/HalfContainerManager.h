...
- (void)updateContainerView:(id)arg0 containerType:(unsigned long long)arg1 params:(id)arg2;
...
- (BOOL)isInRemoveGesture;
- (void)halfContainerDidMove:(double)arg0;
- (void)setIsInRemoveGesture:(BOOL)arg0;
