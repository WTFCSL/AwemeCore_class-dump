...
+ (void)trackFirstFrameAndTrigerEventWithModel:(id)arg0 blockedWithAlertView:(BOOL)arg1;
+ (void)updateIsFirstPlay:(BOOL)arg0;
...
+ (id)p_isFromFamiliarCacheNumber:(id)arg0;
+ (void)addMetricInfoWithName:(id)arg0 start:(double)arg1 endTime:(double)arg2 metrics:(id)arg3;
+ (void)clearDetailsWithFirstFrame;
+ (id)firstFrameLoadTimeWithModel:(id)arg0 blockedWithAlertView:(BOOL)arg1;
