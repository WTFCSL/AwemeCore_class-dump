...
@class UIColor, NSString, AWEPOIRateSymbolIconModel, AWEPOIRateLynxTextView, NSDictionary;

@interface AWEPOIRateSymbolRichTextModel : NSObject {
    NSString *_symbol;
    NSString *_name;
    ...
    NSString *_payload;
    AWEPOIRateSymbolIconModel *_symbolIcon;
...
@property (readonly, nonatomic) AWEPOIRateSymbolIconModel *symbolIcon;
