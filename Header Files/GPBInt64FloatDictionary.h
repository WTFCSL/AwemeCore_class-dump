...
- (void)setFloat:(float)arg0 forKey:(long long)arg1;
...
- (id)initWithFloats:(const float *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndFloatsUsingBlock:(id /* block */)arg0;
- (BOOL)getFloat:(float *)arg0 forKey:(long long)arg1;
- (void)removeFloatForKey:(long long)arg0;
