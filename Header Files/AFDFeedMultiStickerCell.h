...
@class NSString, AFDFeedMultiStickerCellViewController, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AFDFeedMultiStickerCell : UITableViewCell <AWEFeedTableViewCellProtocol> {
    long long _indexPath;
    AFDFeedMultiStickerCellViewController *_viewController;
...
@property (retain, nonatomic) AFDFeedMultiStickerCellViewController *viewController;
