...
@class NSString, UIImageView, AWEPOIIMPigeonConversation, UILabel, UIView, AWEPOICommonModalViewController;
@protocol AWEPOIModalContentDelegate;

@interface AWEPOIIMSettingsMoreModalView : UIView <AWEPOICommonModalCustomContentProtocol> {
