...
@interface BDImageXUploaderClient : NSObject {
    ...
    BOOL _finished;
    id<BDImageXUploadClientDelegate> _delegate;
    ...
    NSMutableDictionary *_e2eInfoDict;
...
- (void)setFileNames:(id)arg0;
- (void)setStoreKeys:(id)arg0;
- (void)setE2EEncInfoDict:(id)arg0;
- (void)setFilePrefix:(id)arg0;
- (void)startPreHeat:(id /* block */)arg0;
- (id)storeKeys;
- (id)e2eInfoDict;
- (void)setE2eInfoDict:(id)arg0;
