...
+ (id)resultWithConversationIdentifier:(id)arg0 response:(id)arg1 status:(int)arg2 checkCode:(long long)arg3 checkMessage:(id)arg4 extraInfo:(id)arg5 error:(id)arg6;

- (id)checkMessage;
- (long long)checkCode;
- (id)initWithConversationIdentifier:(id)arg0 response:(id)arg1 status:(int)arg2 checkCode:(long long)arg3 checkMessage:(id)arg4 extraInfo:(id)arg5 error:(id)arg6;
- (void).cxx_destruct;
- (int)status;
- (id)response;
