...
@class NSString, NSMutableDictionary, ECOMTIMPBNReferenceInfo;

@interface ECOMTIMPBNMessageBody : GPBMessage
...
@property (retain, nonatomic) ECOMTIMPBNReferenceInfo *referenceInfo;
