...
- (id)initWithUInt32s:(const unsigned int *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndUInt32sUsingBlock:(id /* block */)arg0;
- (BOOL)getUInt32:(unsigned int *)arg0 forKey:(long long)arg1;
- (void)setUInt32:(unsigned int)arg0 forKey:(long long)arg1;
- (void)removeUInt32ForKey:(long long)arg0;
