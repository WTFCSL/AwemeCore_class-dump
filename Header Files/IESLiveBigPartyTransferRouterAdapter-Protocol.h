...
@protocol IESLiveBigPartyTransferRouterAdapter <NSObject>
...
- (BOOL)shouldContinueDispatchMessage:(id)arg0;
- (void)updateStartContext:(id)arg0;
- (BOOL)shouldHandleForwardMessage:(id)arg0;
