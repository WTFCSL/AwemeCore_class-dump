...
@interface AWESelectTemplateChoseSegmentView : UIView <UICollectionViewDelegate, UICollectionViewDataSource> {
    ...
    id /* block */ _saveButtonClick;
    id /* block */ _cancelButtonClick;
...
- (id)initWithFrame:(struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })arg0 textEditEnable:(BOOL)arg1 isVideoAndPicMixed:(BOOL)arg2;
...
- (void)setSaveButtonClick:(id /* block */)arg0;
- (void)setCancelButtonClick:(id /* block */)arg0;
