...
@class NSArray, NSString, HGDetentionHelper, HGAlertSpringAnimator, NSError, HGUniqueID;

@interface HGIdentityAuthenticationAlertViewController : HGBaseViewController <HGIdentityAuthenticationAlertViewDelegate, HGGuardianResultViewDelegate, HGGuardianVerifyViewDelegate, HGGuardianConfirmViewDelegate> {
    ...
    HGDetentionHelper *_detentionHelper;
