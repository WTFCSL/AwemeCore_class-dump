...
@interface AWEFriendsImpl.VideoAlbumSectionController : _TtGC14AWEFriendsImpl32RichContentBaseSectionControllerCS_26VideoAlbumSectionViewModel_ <AWEPlayVideoDelegate, AFDAlbumControllerHolder, AFDVideoControllerHolder> {
