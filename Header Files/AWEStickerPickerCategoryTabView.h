...
@interface AWEStickerPickerCategoryTabView : UIView <UICollectionViewDelegate, UICollectionViewDataSource> {
    ...
    id<AWEStickerPickerCategoryTabViewDelegate> _delegate;
    ...
    id<AWEStickerPickerCategoryUIConfigurationProtocol> _UIConfig;
...
- (struct CGRect { struct CGPoint { double x0; double x1; } x0; struct CGSize { double x0; double x1; } x1; })cellFrameForIndex:(long long)arg0;
