...
- (id)initWithNLEModel:(id)arg0 nle:(id)arg1;
...
- (void)setIsTempVideoData:(BOOL)arg0;
- (BOOL)videoAssetsAllMuted;
- (id)addPictureWithURL:(id)arg0 duration:(double)arg1;
...
- (void)updateCanvasConfigsMapWithConfig:(id)arg0 trackSlot:(id)arg1;
...
- (void)beginEdit;
- (BOOL)moveResourceToDraftFolder:(id)arg0;
- (void)syncDataBeforeSaveDraft;
- (void)removeAudioWithAssets:(id)arg0;
- (void)pushUpdateType:(long long)arg0;
...
- (id)stickerChangeMap;
- (void)setStickerChangeMap:(id)arg0;
- (id)initWithNLEModel:(id)arg0 nle:(id)arg1 forbidUpdateNLEModel:(BOOL)arg2;
- (void)updateOldDraftDataToNLE;
- (id)p_syncNLE;
- (BOOL)forbidUpdateNLEModel;
- (void)transNoPublicDraftToPublicDraft;
- (void)_setupNLEStatus;
- (void)syncTextTemplate;
- (void)p_syncVE;
- (BOOL)isTempVideoData;
- (BOOL)audioTrackCannotHandleWithAudioAsset:(id)arg0;
...
- (void)transPublicDraftToNoPublicDraft;
- (void)acc_fixAudioClipRange;
- (void)setUpdateTypes:(id)arg0;
- (void)setForbidUpdateNLEModel:(BOOL)arg0;
- (void).cxx_destruct;
