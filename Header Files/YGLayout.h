...
@interface YGLayout : NSObject {
    ...
    BOOL _isUIView;
    struct YGNode { } *_node;
    id<YGLayoutDelegate> _delegate;
    UIView *_view;
    struct UIEdgeInsets { double top; double left; double bottom; double right; } _contentInsets;
    struct UIEdgeInsets { double top; double left; double bottom; double right; } _contentOutsets;
}
...
- (void)setContentOutsets:(struct UIEdgeInsets { double x0; double x1; double x2; double x3; })arg0;
