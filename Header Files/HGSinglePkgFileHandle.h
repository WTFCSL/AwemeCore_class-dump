...
@class NSString, HGPkgFileBasicModel, HGTTPkgLoader, NSObject;
@protocol HGFileHandleLifecycleDelegate, OS_dispatch_semaphore;

@interface HGSinglePkgFileHandle : NSObject <HGTTPkgLoaderDelegate, HGFileHandleFullProtocol> {
