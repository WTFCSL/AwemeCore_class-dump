...
- (void)removeAll;
- (void)setDouble:(double)arg0 forKey:(long long)arg1;
- (id)init;
...
- (id)initWithDoubles:(const double *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndDoublesUsingBlock:(id /* block */)arg0;
- (BOOL)getDouble:(double *)arg0 forKey:(long long)arg1;
- (void)removeDoubleForKey:(long long)arg0;
