...
@class UIView, NSString, NSArray, UIImage, NSAttributedString, UITextView, UIImageView, UITapGestureRecognizer, UIWindow, UILabel;

@interface AWEUIAlertView : UIView <AWEUIAlertViewLocationProtocol, ACCUIAlertViewProtocol, UIGestureRecognizerDelegate> {
...
- (id)adjustedActionsForActions:(id)arg0 recommendedActionIndex:(long long *)arg1;
...
- (void)addViewOverHeaderImageView:(id)arg0;
