...
@class HGSTLQueue, HGStarkPlatform, NSString, HGStarkRuntime, HGUniqueID;

@interface HGStarkPage : HGBridgeWebView <HGWebViewImplInterface, WKNavigationDelegate> {
    BOOL _isPause;
    BOOL _isStarted;
    BOOL _didStopped;
...
@property (weak, nonatomic) HGStarkRuntime *runtime;
@property (retain, nonatomic) HGStarkPlatform *platform;
