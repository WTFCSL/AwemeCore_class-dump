...
@class AWEFeedLongVideoCellViewController, NSString, AWEAwemeModel, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEFeedLongVideoTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol> {
    BOOL _hadPrepareToDisplay;
    long long _indexPath;
    AWEFeedLongVideoCellViewController *_viewController;
...
@property (retain, nonatomic) AWEFeedLongVideoCellViewController *viewController;
