...
@interface DitoGeneralContainerTagsViewModel : DitoComponentViewModel <DitoComponentStickyProtocol> {
    ...
    NSString *_optionKey;
    DitoGeneralContainerTagsView *_tagsView;
    NSString *_selectedTagKey;
    DitoSwitchNodeActionOperation *_switchTagOperation;
    DitoGeneralContainerTagItem *_selectedItem;
    UIScrollView *_p_stickView;
}
...
- (void)scrollTagsViewToTopAnimiated:(BOOL)arg0 delayMilliSeconds:(long long)arg1;
- (void)scrollTagItemViewToCenter:(id)arg0;
