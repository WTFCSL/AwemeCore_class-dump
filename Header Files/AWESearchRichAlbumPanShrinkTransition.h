...
@protocol AWEPlayVideoViewControllerProtocol, AFDRichAwemeFullPageViewControllerProtocol, AFDSlidesViewProtocol;

@interface AWESearchRichAlbumPanShrinkTransition : NSObject <AWETransitionContextProvider> {
    UIView *_containerView;
    NSObject<AFDRichAwemeFullPageViewControllerProtocol> *_fromCP;
    UIView *_fromView;
...
@property (retain, nonatomic) NSObject<AFDRichAwemeFullPageViewControllerProtocol> *fromCP;
