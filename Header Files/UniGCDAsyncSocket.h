...
@class NSData, NSString, NSURL, UniGCDAsyncSocketPreBuffer, UniGCDAsyncReadPacket, UniGCDAsyncWritePacket, NSObject, NSMutableArray;
@protocol UniGCDAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface UniGCDAsyncSocket : NSObject {
    unsigned int flags;
    unsigned short config;
    id<UniGCDAsyncSocketDelegate> delegate;
    ...
    UniGCDAsyncReadPacket *currentRead;
    UniGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    UniGCDAsyncSocketPreBuffer *preBuffer;
    ...
    UniGCDAsyncSocketPreBuffer *sslPreBuffer;
...
@property (weak) id<UniGCDAsyncSocketDelegate> delegate;
...
- (id)errorWithErrno:(int)arg0 reason:(id)arg1;
- (BOOL)connectToNetService:(id)arg0 error:(id *)arg1;
- (BOOL)isIPv6;
- (BOOL)isSecure;
- (id)localAddress;
