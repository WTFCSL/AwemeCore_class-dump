...
@interface AWEURLModel : MTLModel <ACCURLModelProtocol, AWEStudioURLModelProtocol, MTLJSONSerializing, AWEProcessRequestInfoProtocol> {
    NSArray *URLList;
...
@property (readonly, copy, nonatomic) NSString *summerCallingResourceKey;
...
- (void)convertUrlListAddAnimatedCoverParams:(id)arg0;
- (void)filterPlayURLList;
- (BOOL)isEqualByURI:(id)arg0;
- (id)summerCallingResourceKey;
- (BOOL)needsCommonParametersForURL:(id)arg0;
- (id)URI;
- (id)init;
