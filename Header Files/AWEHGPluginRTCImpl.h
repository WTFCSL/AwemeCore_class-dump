...
@class NSString, AWEHGRTCEngine;

@interface AWEHGPluginRTCImpl : NSObject <HGRTCPluginDelegate, ByteRTCVideoDelegate, ByteRTCMonitorDelegate> {
    AWEHGRTCEngine *_engine;
}

@property (retain, nonatomic) AWEHGRTCEngine *engine;
