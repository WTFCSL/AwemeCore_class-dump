...
@protocol ACCFeatureComponent, ACCRecorderViewContainer, AWETeenSwitchPropPanelService;

@interface AWETeenRecordGestureComponentPlugin : ACCFeatureComponent <ACCFeatureComponentPlugin, ACCServiceBindable> {
