...
@class LiveStreamCapture, NSString, IESLiveEffectMessageDispatcherProviderImp, IESLivePushStreamLogger;

@interface IESLiveEffectVideoStreamServiceImp : NSObject <IESLiveVideoEffectProcessing> {
    BOOL _useAmazingEffectEngine;
    LiveStreamCapture *_liveCapture;
    long long _previousResultCount;
    IESLiveEffectMessageDispatcherProviderImp *_effectMessageDispatcher;
    IESLivePushStreamLogger *_logger;
}
...
- (void)setPreviousResultCount:(long long)arg0;
- (id)effectMessageDispatcher;
- (unsigned long long)getLSLiveEffectGestureTypeFromLiveType:(unsigned long long)arg0;
- (void)renderFilterApplyComposerNodes:(id)arg0 tags:(id)arg1;
- (void)renderFilterRemoveComposerNodes:(id)arg0 tags:(id)arg1;
- (void)setUseAmazingEffectEngine:(BOOL)arg0;
- (void)setEffectMessageDispatcher:(id)arg0;
- (id)logger;
