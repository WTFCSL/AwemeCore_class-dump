...
- (void)setRawValue:(int)arg0 forKey:(long long)arg1;
- (id)initWithDictionary:(id)arg0;
- (id)copyWithZone:(struct _NSZone { } *)arg0;
- (id)initWithValidationFunction:(void /* function */ *)arg0 rawValues:(const int *)arg1 forKeys:(const long long *)arg2 count:(unsigned long long)arg3;
- (void)writeToCodedOutputStream:(id)arg0 asField:(id)arg1;
- (BOOL)getEnum:(int *)arg0 forKey:(long long)arg1;
- (unsigned long long)count;
- (void)setEnum:(int)arg0 forKey:(long long)arg1;
...
- (BOOL)getRawValue:(int *)arg0 forKey:(long long)arg1;
- (void)enumerateForTextFormat:(id /* block */)arg0;
- (void)removeEnumForKey:(long long)arg0;
