...
@class NSString, HGPermissionAlertView, UIView;

@interface HGPermissionAlertController : UIViewController <HGPermissionViewDelegate, UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, HGPermissionAlertControllerProtocol> {
