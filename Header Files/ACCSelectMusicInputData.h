...
@interface ACCSelectMusicInputData : NSObject <ACCSelectMusicInputDataProtocol> {
    ...
    id<ACCChallengeModelProtocol> challenge;
    long long sceneType;
    ...
    NSDictionary *clipTrackInfo;
    id<ACCMusicModelProtocol> musicSelectInPanel;
    ACCMusicTrimViewSnapShootModel *imageMusicTrimStatusModel;
    struct _HTSAudioRange { double location; double length; } audioRange;
}
