...
- (BOOL)videoPinAB;
- (void)pinVideoCommentNode:(id)arg0 actionType:(unsigned long long)arg1 finish:(id /* block */)arg2;
- (id)fetchVideoParamsWithNode:(id)arg0;
- (void)trackVideoPinActionItemClickWith:(id)arg0;
- (void)trackVideoPinClickPlayWith:(id)arg0;
- (void)trackVideoPinShowWithNode:(id)arg0;
- (void)setVideoPinAB:(BOOL)arg0;
- (void).cxx_destruct;
- (id)delegate;
