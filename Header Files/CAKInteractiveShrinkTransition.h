...
@interface CAKInteractiveShrinkTransition : NSObject <CAKAlbumTransitionContextProvider> {
    ...
    UIViewController<CAKAlbumZoomTransitionInnerContextProvider> *_fromCP;
    UIViewController<CAKAlbumZoomTransitionOuterContextProvider> *_toCP;
...
- (id)toCP;
- (id)fromCP;
- (id)initWithTransitionDelegate:(id)arg0;
