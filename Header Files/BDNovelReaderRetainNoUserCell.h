...
@class UIImageView, UILabel, BDNovelReaderRetainNoUserBook;

@interface BDNovelReaderRetainNoUserCell : UITableViewCell {
    UIImageView *_coverView;
    UILabel *_scoreLabel;
    UILabel *_bookNameLabel;
    UILabel *_abstractLabel;
    UILabel *_infoLabel;
    BDNovelReaderRetainNoUserBook *_book;
}
...
@property (retain, nonatomic) BDNovelReaderRetainNoUserBook *book;
