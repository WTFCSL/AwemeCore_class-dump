...
- (BOOL)getUInt64:(unsigned long long *)arg0 forKey:(long long)arg1;
- (id)description;
- (void)setUInt64:(unsigned long long)arg0 forKey:(long long)arg1;
- (void)dealloc;
...
- (id)initWithUInt64s:(const unsigned long long *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndUInt64sUsingBlock:(id /* block */)arg0;
- (void)removeUInt64ForKey:(long long)arg0;
