...
@interface IESLiveGameSEIPacketProcessPipeline : NSObject <IESLiveSocialInteractAction, IESLiveMultiAudioAction, IESLivePipelineDelegate> {
...
- (unsigned long long)getMsgContentTypeWithName:(id)arg0;
- (unsigned long long)getMsgContentTypeWithUpdateKey:(id)arg0 extraInfo:(id)arg1;
