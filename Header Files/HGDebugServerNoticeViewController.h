...
@protocol HGDebugServerNoticeViewDelegate;

@interface HGDebugServerNoticeViewController : UIViewController {
    id<HGDebugServerNoticeViewDelegate> _delegate;
...
@property (weak, nonatomic) id<HGDebugServerNoticeViewDelegate> delegate;
