...
@class HGSCModel, HGSCDownloadInfo;

@interface HGStarkLoadInstance : HGBaseLoadInstance {
    BOOL _isDOMReady;
    HGSCModel *_scModel;
    HGSCDownloadInfo *_downloadInfo;
...
@property (retain, nonatomic) HGSCModel *scModel;
@property (retain, nonatomic) HGSCDownloadInfo *downloadInfo;
