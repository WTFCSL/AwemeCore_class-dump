...
@class AWEAwemeModel, AWELandscapeSectionViewModel, NSString, UIImageView, UIViewController, AWELandscapeContext, AWELandscapePageContext, AWELandscapeVideoViewController;
@protocol AWEAwemePlayVideoViewControllerProtocol, AWEPlayVideoViewControllerProtocol, AWEAwemeBizPlayVideoProtocol;

@interface AWELandscapePlayerCell : UICollectionViewCell <AWELandscapeVideoViewControllerDelegate, AWELandscapePlayProtocol> {
    ...
    AWELandscapeVideoViewController *_landscapeVideoViewController;
...
@property (retain, nonatomic) AWELandscapeVideoViewController *landscapeVideoViewController;
