...
@interface __RTVAWEIMEmoticonModel : NSObject <AWEIMEmoticonModelProtocol> {
    BOOL hide;
    NSNumber *height;
    NSString *emoticonTitle;
    NSString *animate_url;
    NSString *emoticonIcon;
    NSNumber *width;
    NSString *static_uri;
    NSString *originUniqueId;
    long long originThemeStyle;
    NSDictionary *display_name_lang;
    NSString *static_url;
    NSString *animate_uri;
...
- (id)static_type;
- (id)initWithRTVEmoticon:(id)arg0;
