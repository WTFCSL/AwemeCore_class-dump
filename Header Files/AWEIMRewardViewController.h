...
@interface AWEIMRewardViewController : UIViewController <AWENoticeCellEditUtilityProtocol, UITableViewDelegate, UITableViewDataSource, AWEIMNoticeUserAction, AWEUserMessage, AWERouterViewControllerProtocol, AWEIMDanmakuSlidingChildControllerProtocol> {
