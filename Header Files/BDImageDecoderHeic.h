...
@interface BDImageDecoderHeic : NSObject <BDImageDecoder, BDThumbImageDecoder> {
    ...
    struct TTHEIFContext { struct TTBytevc1DecoderContext *dec_ctx; struct TTHeifBox *heif_box; } _context;
...
- (struct HeifOutputStream { unsigned int x0; char *x1; unsigned int x2; char *x3; unsigned long long *x4; unsigned int x5; unsigned int x6; unsigned int x7; unsigned long long x8; unsigned long long x9; unsigned char x10; char *x11; unsigned int x12; int x13; })decodeAnimatedImageAtIndex:(unsigned long long)arg0;
- (long long)frames;
...
- (void)setContext:(struct TTHEIFContext { struct TTBytevc1DecoderContext *x0; struct TTHeifBox *x1; })arg0;
- (id)config;
- (void)setData:(id)arg0;
- (long long)orientation;
- (void)setCanvasSize:(struct CGSize { double x0; double x1; })arg0;
- (long long)index;
- (struct TTHEIFContext { struct TTBytevc1DecoderContext *x0; struct TTHeifBox *x1; })context;
