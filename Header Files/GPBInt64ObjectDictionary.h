...
- (void)removeObjectForKey:(long long)arg0;
...
- (id)description;
- (id)objectForKey:(long long)arg0;
- (void)dealloc;
- (void)addEntriesFromDictionary:(id)arg0;
- (id)initWithObjects:(const id *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
