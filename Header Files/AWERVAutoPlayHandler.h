...
@interface AWERVAutoPlayHandler : NSObject <UIScrollViewDelegate> {
    ...
    AWERVAutoPlayHandler *_superHandler;
    UIView<AWERVAutoPlayCardProtocol> *_currentActiveView;
    NSArray *_sortedRules;
    double _activeRectTop;
    double _activeRectBottom;
    double _shouldNotActiveHeight;
    id<AWERVAutoPlayContainerProtocol> _container;
    NSMutableDictionary *_rulePlugins;
    UIView<AWERVAutoPlayCardProtocol> *_currentTransitionActiveView;
