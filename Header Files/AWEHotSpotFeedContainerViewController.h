...
@class NSString, AWENewHotSpotPageContext, AWENewHotSpotFeedDataController, AWEUILoadingView, AWENewHotSpotFeedParamsModel, NSMutableArray, NSDictionary, UIViewController, NSNumber, AWECommonFeedContainerViewController;
@protocol AWENewHotSpotVideoFeedContainerProtocol;

@interface AWEHotSpotFeedContainerViewController : UIViewController <AWECommonFeedDelegate, AWECommonFeedFullScreenDetailDelegate, AWENewHotSpotFeedVCProtocol> {
