...
@class HGUniqueID, HGPrivacyAccessAnimator, HGMorePanel, HGBubbleView, UIView, CALayer, UIButton;
@protocol HGToolBarViewDelegate;

@interface HGToolBarView : UIView {
    BOOL _forcedMoreEnable;
    BOOL _needGameCenter;
    long long _toolbarStyle;
    long long _toolBarThemeStyle;
    id<HGToolBarViewDelegate> _delegate;
    HGBubbleView *_bubbleView;
    HGUniqueID *_uniqueID;
    HGPrivacyAccessAnimator *_privacyIconAnimator;
    id /* block */ _onTapClose;
...
@property (retain, nonatomic) HGPrivacyAccessAnimator *privacyIconAnimator;
@property (weak, nonatomic) HGMorePanel *panel;
...
@property (weak, nonatomic) id<HGToolBarViewDelegate> delegate;
@property (retain, nonatomic) HGBubbleView *bubbleView;
...
- (void)setOnTapClose:(id /* block */)arg0;
