...
- (id)initWithInt64s:(const long long *)arg0 forKeys:(const BOOL *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndInt64sUsingBlock:(id /* block */)arg0;
- (BOOL)getInt64:(long long *)arg0 forKey:(BOOL)arg1;
- (void)setInt64:(long long)arg0 forKey:(BOOL)arg1;
