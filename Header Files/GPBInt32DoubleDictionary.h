...
- (void)removeAll;
- (void)setDouble:(double)arg0 forKey:(int)arg1;
- (id)init;
...
- (id)initWithDoubles:(const double *)arg0 forKeys:(const int *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndDoublesUsingBlock:(id /* block */)arg0;
- (BOOL)getDouble:(double *)arg0 forKey:(int)arg1;
