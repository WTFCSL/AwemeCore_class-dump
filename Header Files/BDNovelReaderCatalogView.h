...
@class BDNovelReaderSlider, BDReaderConfig, NSString, UIView, BDNovelReaderCatalogTopView, UITableView;

@interface BDNovelReaderCatalogView : BDNovelReaderBaseCatalogView <UITableViewDelegate, UITableViewDataSource, BDNovelReaderSliderDelegate, BDNovelReaderCatalogTopViewDelegate> {
    BDNovelReaderCatalogTopView *_topView;
...
@property (retain, nonatomic) BDNovelReaderCatalogTopView *topView;
