...
@interface AWEMultiContentImageTextTransitionController : AWEBaseController <AFDAlbumDetailTransitionOuterContextProvider, AWERichContentAdapterBasic.RichContentAlbumTransitionControllerProtocol> {
