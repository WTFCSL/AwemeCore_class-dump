...
@interface TTAirPlayNetStatusDetector : NSObject <ByteRTCRoomDelegate> {
    float _lossRate;
...
- (long long)calcNetStatusAndCallBack:(id)arg0;
- (void)setXPlayQualityModelWithRemoteStreamStats:(id)arg0;
- (id)init;
- (void).cxx_destruct;
- (id)queue;
