...
@class NSString, NSMutableArray, HGVideoEditProcessInfo;

@interface HGPluginVideoEditImpl : NSObject <HGVideoEditPluginDelegate> {
    NSMutableArray *_videoProcessList;
    HGVideoEditProcessInfo *_currentProcessInfo;
}

@property (retain, nonatomic) NSMutableArray *videoProcessList;
@property (retain) HGVideoEditProcessInfo *currentProcessInfo;
