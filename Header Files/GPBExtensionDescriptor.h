...
- (BOOL)isPackable;
- (Class)msgClass;
- (long long)compareByFieldNumber:(id)arg0;
- (id)initWithExtensionDescription:(struct GPBExtensionDescription { union { BOOL x0; int x1; long long x2; unsigned int x3; unsigned long long x4; float x5; double x6; id x7; id x8; id x9; int x10; } x0; char *x1; char *x2; char *x3; void /* function */ *x4; int x5; unsigned char x6; unsigned char x7; } *)arg0;
- (id)singletonName;
