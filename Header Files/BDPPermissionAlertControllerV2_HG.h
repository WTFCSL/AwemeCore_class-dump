...
@class NSString, BDPPermissionAlertView_HG, UIView, BDPUniqueID;

@interface BDPPermissionAlertControllerV2_HG : BDPBaseAlertViewController <BDPPermissionViewDelegate_HG, BDPPermissionAlertControllerProtocol_HG> {
