...
@interface ECOMTIMMessageORM : ECOMTIMBaseORM <WCTTableCoding, ECOMTIMOMessageBrief, ECOMTIMMessageModelProtocol> {
    BOOL _deleted;
    BOOL _hasRead;
    BOOL _unreadMention;
    ...
    id<ECOMTIMMessageKVModelProtocol> _referMessageKVObj;
}
