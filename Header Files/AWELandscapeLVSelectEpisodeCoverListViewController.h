...
@class UIView, AWEAwemeModel, AWELandscapeLongVideoNetworkErrorView, AWELandscapeLVSelectEpisodeDataController, NSString, AWECollectionButton, AWEUILoadingView, UICollectionView, DUXButton, AWELandscapePageContext, AWELandscapeFeedViewModel;
@protocol AWELandscapeSplitScreenContainerDelegate, AWELVAlbumFavoriteButtonProtocol;

@interface AWELandscapeLVSelectEpisodeCoverListViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, AWELandscapeLVSelectEpisodeViewControllerProtocol> {
    BOOL _isRequesting;
    BOOL _isScrolling;
