...
@interface AWEPadSkyLightTopBarViewModel : NSObject <UIGestureRecognizerDelegate, AWEBaseListViewControllerDataSource, UIScrollViewDelegate, AWESkyLightTopBarViewModelProtocol> {
    ...
    AWEPadSkyLightTopBarViewController *_topBarView;
...
- (void)updateNewSectionWithOldSectionData:(BOOL)arg0 oldUpdateError:(id)arg1 completion:(id /* block */)arg2;
- (BOOL)isSkyLightStatusChanged;
- (void)setIsSkyLightStatusChanged:(BOOL)arg0;
