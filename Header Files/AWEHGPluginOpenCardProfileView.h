...
@class UIView, NSString, AWEUserModel, AWEHGCloseBtn, UIImageView, UIButton, NSMutableArray, NSLayoutConstraint, UILabel, HGUniqueID;

@interface AWEHGPluginOpenCardProfileView : UIView <UIGestureRecognizerDelegate> {
    NSString *_info;
...
@property (retain, nonatomic) AWEHGCloseBtn *closeBtn;
