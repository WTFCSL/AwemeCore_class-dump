...
- (BOOL)getUInt64:(unsigned long long *)arg0 forKey:(id)arg1;
- (id)description;
- (void)setUInt64:(unsigned long long)arg0 forKey:(id)arg1;
- (void)dealloc;
...
- (id)initWithUInt64s:(const unsigned long long *)arg0 forKeys:(id *)arg1 count:(unsigned long long)arg2;
