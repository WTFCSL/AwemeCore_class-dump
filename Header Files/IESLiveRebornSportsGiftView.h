...
@class UIView, NSString, HTSLiveArtTextLabel, CALayer, IESLiveGCDTimer, IESLiveRebornGiftAnimationNode, CAGradientLayer, IESLiveImageView, UILabel;
...
@interface IESLiveRebornSportsGiftView : IESLiveRebornGiftView {
    ...
    IESLiveImageView *_containerView;
    UILabel *_nickNameLabel;
    UILabel *_descriptionLabel;
    IESLiveImageView *_giftView;
    ...
    IESLiveGCDTimer *_stopAnimationTimer;
...
@property (retain, nonatomic) IESLiveImageView *giftView;
...
- (void)p_setContainerViewWidth:(id)arg0;
- (void)p_updateContainerWidthIfNeeded:(id)arg0;
- (void)setStopAnimationTimer:(id)arg0;
- (double)p_getComboContainerWidthWithText:(id)arg0;
