...
- (void)setAuthorizationHeaderFieldWithToken:(id)arg0;
...
- (id)requestWithMethod:(id)arg0 URLString:(id)arg1 parameters:(id)arg2;
- (id)multipartFormRequestWithMethod:(id)arg0 URLString:(id)arg1 parameters:(id)arg2 constructingBodyWithBlock:(id /* block */)arg3;
- (id)requestWithMultipartFormRequest:(id)arg0 writingStreamContentsToFile:(id)arg1 completionHandler:(id /* block */)arg2;
