...
@protocol HGValueProtocol;

@interface HGQJContext : NSObject <HGContextProtocol> {
    struct LEPUSContext { } *qjs_context;
    id /* block */ _exceptionHandler;
    BOOL _useOuter;
    long long logExceptionFlag;
    NSMutableDictionary *_errorInfo;
}

@property (retain, nonatomic) NSMutableDictionary *errorInfo;
@property (nonatomic) BOOL useOuter;
@property (readonly, nonatomic) id<HGValueProtocol> exception;
...
- (BOOL)useOuter;
- (union LEPUSValue { long long x0; void *x1; double x2; })wrapNSBlock:(id)arg0;
- (void)setUseOuter:(BOOL)arg0;
- (id)initWithContext:(struct LEPUSContext { } *)arg0;
- (id)init;
- (struct OpaqueJSContext { } *)JSGlobalContextRef;
- (void).cxx_destruct;
- (void)notifyException:(id)arg0;
...
- (void)_init:(struct LEPUSRuntime { } *)arg0;
