...
@interface AWEU18VerificationRefactorThreadSafeStorage : NSObject <AWEU18VerificationThreadSafeStorageProtocol> {
...
- (void)cleanAllData;
- (id)p_getKeyStrWithNumber:(id)arg0;
- (void)p_saveToDisk:(id)arg0 forKey:(id)arg1;
- (void)p_cleanDiskDataForKey:(id)arg0;
- (void)p_archiveDataToDisk:(id)arg0 forKey:(id)arg1;
