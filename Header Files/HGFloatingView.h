...
@class NSString, UIImageView, UIVisualEffectView, HGFloatingViewSettingsManager, HGUniqueID;
@protocol HGFloatingDelegate;

@interface HGFloatingView : UIView <LOTAnimationDelegate, HGApplicationLifeCycleMessage> {
    BOOL _curPositionLeft;
    BOOL _isTouch;
    id<HGFloatingDelegate> _floatingDelegate;
    HGFloatingViewSettingsManager *_settingsManager;
    double _radius;
    UIImageView *_icon;
...
@property (retain, nonatomic) HGFloatingViewSettingsManager *settingsManager;
