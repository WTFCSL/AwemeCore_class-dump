...
@class NSString, HGUniqueID, HGAlertController;
@protocol HGOnlineTimeReporterDelegate;

@interface HGOnlineTimeReporter : NSObject <HGOnlineTimeReportedNotifyDelegate> {
    BOOL _isAuthenticating;
    id<HGOnlineTimeReporterDelegate> _delegate;
    HGUniqueID *_uniqueID;
    HGAlertController *_offlineAlertViewController;
}

@property (retain, nonatomic) HGUniqueID *uniqueID;
@property (retain, nonatomic) HGAlertController *offlineAlertViewController;
@property (nonatomic) BOOL isAuthenticating;
@property (weak, nonatomic) id<HGOnlineTimeReporterDelegate> delegate;
