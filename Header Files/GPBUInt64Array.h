...
+ (id)arrayWithValue:(unsigned long long)arg0;

- (void)removeAll;
- (id)init;
- (void)insertValue:(unsigned long long)arg0 atIndex:(unsigned long long)arg1;
- (id)copyWithZone:(struct _NSZone { } *)arg0;
- (unsigned long long)valueAtIndex:(unsigned long long)arg0;
- (void)replaceValueAtIndex:(unsigned long long)arg0 withValue:(unsigned long long)arg1;
...
- (id)initWithValues:(const unsigned long long *)arg0 count:(unsigned long long)arg1;
- (BOOL)isEqual:(id)arg0;
- (void)removeValueAtIndex:(unsigned long long)arg0;
- (void)addValues:(const unsigned long long *)arg0 count:(unsigned long long)arg1;
- (id)description;
- (void)enumerateValuesWithBlock:(id /* block */)arg0;
- (void)dealloc;
- (void)addValuesFromArray:(id)arg0;
- (id)initWithValueArray:(id)arg0;
- (void)addValue:(unsigned long long)arg0;
