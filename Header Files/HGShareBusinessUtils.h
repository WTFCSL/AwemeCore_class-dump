...
@class NSString, NSMapTable, HGMultiDelegateProxy;
@protocol HGShareBusinessHandler;

@interface HGShareBusinessUtils : NSObject <HGWarmBootMessage, HGWebViewComponentURLSwitchMessage, HGAppRouteChangeMessage> {
    NSMapTable *_webURLShareParams;
    HGMultiDelegateProxy<HGShareBusinessHandler> *_defaultHandlers;
    NSMapTable *_channelHandlers;
    id /* block */ _isBottomBarShowBlk;
}

@property (retain) NSMapTable *webURLShareParams;
@property (retain) HGMultiDelegateProxy<HGShareBusinessHandler> *defaultHandlers;
...
+ (void)startShareWithUniqueID:(id)arg0 params:(id)arg1;
