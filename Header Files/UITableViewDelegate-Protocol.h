...
- (id)tableView:(id)arg0 contextMenuConfigurationForRowAtIndexPath:(id)arg1 point:(struct CGPoint { double x0; double x1; })arg2;
...
- (long long)tableView:(id)arg0 accessoryTypeForRowWithIndexPath:(id)arg1;
...
- (long long)tableView:(id)arg0 indentationLevelForRowAtIndexPath:(id)arg1;
