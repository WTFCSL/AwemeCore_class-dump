...
@class UIImageView, UILabel, UIView, AWELeftSideBarWatchVideoLaterHeaderUIConfig;
...
@interface AWELSBWatchVideoLaterHeaderView : UIView {
    ...
    UIView *_divideLine;
    UILabel *_titleLabel;
    AWELeftSideBarWatchVideoLaterHeaderUIConfig *_uiConfig;
}
...
- (void)showAllTip:(BOOL)arg0;
- (void)updateShowAllTextWithUnreadCount:(long long)arg0;
- (id)showAllLabel;
- (id)divideLine;
