...
@class UILabel, AWETemplateHotspotSeparatorView, UIImageView, NSString, UIView, AWETemplateBarModel, AWETemplateBarContext;
...
@interface AWETemplateHotspotView : UIView <AWETemplateViewProtocol> {
    ...
    UILabel *_titleLabel;
    AWETemplateHotspotSeparatorView *_separatorView;
    UILabel *_mainContent;
    UILabel *_contentSeparatorLabel;
...
@property (retain, nonatomic) UILabel *contentSeparatorLabel;
...
- (void)setContentSeparatorLabel:(id)arg0;
