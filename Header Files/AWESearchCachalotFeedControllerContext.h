...
@interface AWESearchCachalotFeedControllerContext : NSObject <AWEModernFeedCellContext, NSCopying> {
    ...
    id /* block */ _currentViewControllerBlock;
    ...
    id /* block */ _scrollToDisplayItemWithCompletionBlock;
    id /* block */ _cardTopScreenOffsetBlock;
    ...
    AWESearchCachalotResultContext *_resultContext;
    NSString *_searchType;
    id _bindedData;
    long long _sectionIndex;
    id<CachalotRenderPipelineComponentViewModel> _componentViewModel;
    ...
    id /* block */ _loadMoreAwemeListAtIndexBlock;
    id /* block */ _idleTaskManagerBlock;
    UIScrollView *_videoFeedScrollView;
    UIScrollView *_cachalot_videoFeedScrollView;
...
- (id /* block */)currentViewControllerBlock;
- (id /* block */)scrollToDisplayItemWithCompletionBlock;
- (void)setScrollToDisplayItemWithCompletionBlock:(id /* block */)arg0;
- (id /* block */)cardTopScreenOffsetBlock;
- (void)setCardTopScreenOffsetBlock:(id /* block */)arg0;
- (void)setCurrentViewControllerBlock:(id /* block */)arg0;
- (id /* block */)loadMoreAwemeListAtIndexBlock;
- (void)setLoadMoreAwemeListAtIndexBlock:(id /* block */)arg0;
- (id /* block */)idleTaskManagerBlock;
- (void)setIdleTaskManagerBlock:(id /* block */)arg0;
- (void)removeRecommendWordsCardAnimated:(BOOL)arg0 cardHeight:(double)arg1;
- (id)fetchCurrentViewController;
- (id)resultContext;
- (void)setResultContext:(id)arg0;
- (id)componentViewModel;
- (void)setComponentViewModel:(id)arg0;
- (BOOL)recommendWordsShowing;
- (void)setRecommendWordsShowing:(BOOL)arg0;
