...
@class NSTimer, NSString, AWEECNewBottomMallViewController, AWEBizTabBarItemConfigBadgeModel, AWETabbarGeneralButton, AWEMultiTabMallIconModel2, AWEFeedChannelEnterModel, AWEMultiTabMallBadgeModel;
...
@interface AWEBizTabBarMallItemConfig : NSObject <AWEBizTabBarMessage, AWEBizTabBarLightModeListenerProtocol, AWEECMallBubbleAndRedDotProtocol, AWEUserMessage, AWEBizTabBarItemConfigProtocol> {
    ...
    AWEECNewBottomMallViewController *_mallController;
...
@property (retain, nonatomic) AWEECNewBottomMallViewController *mallController;
