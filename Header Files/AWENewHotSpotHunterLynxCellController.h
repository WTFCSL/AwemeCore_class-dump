...
@class NSString, AWENewHotSpotFeedCardModel, AWEHotSpotHunterLynxView, UIViewController;
@protocol AWEModernFeedCellContext;

@interface AWENewHotSpotHunterLynxCellController : UIViewController <AWEHotSpotLynxCardContainerDelegate, AWEModernFeedCellControllerProtocol> {
    BOOL _isShowingOnView;
    id<AWEModernFeedCellContext> _context;
    AWEHotSpotHunterLynxView *_lynxView;
...
@property (weak, nonatomic) AWEHotSpotHunterLynxView *lynxView;
...
- (void)changeHunterVideoWithStatus:(id)arg0;
