...
@class NSString, AWESpecialCardTemplateCellViewController, AWEAwemeModel, UIView, UIViewController;
...
@interface AWESpecialCardTemplateCell : UITableViewCell <AWEFeedTableViewCellProtocol> {
    ...
    AWESpecialCardTemplateCellViewController *_viewController;
}

@property (retain, nonatomic) AWESpecialCardTemplateCellViewController *viewController;
