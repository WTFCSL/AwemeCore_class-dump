...
@protocol AWESearchAutoPlayDelegateProtocol, AWESearchAutoPlayContainerProtocol, AWESearchAutoPlayCardProtocol;
...
@interface AWESearchAutoPlayHandler : NSObject <UIScrollViewDelegate> {
    ...
    BOOL _isAppActive;
    AWESearchAutoPlayHandler *_superHandler;
    UIView<AWESearchAutoPlayCardProtocol> *_currentActiveView;
    id<AWESearchAutoPlayDelegateProtocol> _autoPlayDelegate;
    ...
    UIView<AWESearchAutoPlayCardProtocol> *_currentTransitionActiveView;
...
- (void)autoPlayDidActiveCard:(id)arg0;
