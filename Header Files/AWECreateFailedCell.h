...
@interface AWECreateFailedCell : UITableViewCell {
    AWECreateInfoModel *_model;
    UIImageView *_iconImageView;
    UILabel *_fileNameLabel;
    UILabel *_createFailedStatusLabel;
...
@property (retain, nonatomic) UILabel *createFailedStatusLabel;
...
- (id)createFailedStatusLabel;
- (void)retryButtonClick:(id)arg0;
- (void)setCreateFailedStatusLabel:(id)arg0;
