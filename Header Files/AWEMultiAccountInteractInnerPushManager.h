...
- (BOOL)canShowInteractInnerPushRightNow:(id)arg0;
- (id)sbcSocialInteractionInAppPushType:(id)arg0;
- (id)attributedTitle:(id)arg0;
- (id)attributedContent:(id)arg0;
- (id)subscripImage:(long long)arg0;
- (BOOL)isLive;
- (id)init;
- (void).cxx_destruct;
- (void)dealloc;
