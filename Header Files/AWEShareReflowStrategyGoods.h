...
- (id)longURL;
- (unsigned long long)tokenTypeToAweChannelType:(long long)arg0;
- (id)getEcomShareTrackParamsWithSchema:(id)arg0 longDic:(id)arg1 eventParams:(id)arg2 tokenFromType:(long long)arg3;
- (id)ecomShareBackTrackWithEventParams:(id)arg0 schema:(id)arg1 longDic:(id)arg2 tokenFromType:(long long)arg3 logInfoMap:(id)arg4;
- (id)shareTokenNoteCardView:(id)arg0 extraData:(id)arg1;
- (id)addEcomShareTrackParams:(id)arg0 params:(id)arg1;
