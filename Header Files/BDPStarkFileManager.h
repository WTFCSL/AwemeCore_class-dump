...
@interface BDPStarkFileManager : NSObject

+ (struct BDPStarkFileMatchResult { BOOL x0; BOOL x1; unsigned long long x2; })tryMatchSCFileUrl:(id)arg0 withScheme:(id)arg1 baseName:(id)arg2;
