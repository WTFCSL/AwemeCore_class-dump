...
@protocol AFDAlbumPageContextProtocol;

@interface AWEFriendsImpl.RichContentPageContext : AWERichContentAdapterBasic.RichContentBasePageContext <AFDRichContentPageContextProtocol> {
    void /* unknown type, empty encoding */ broadcastContext;
...
@property (nonatomic, retain) void /* unknown type, empty encoding */ broadcastContext;
...
- (void)setBroadcastContext:(id)arg0;
- (id)pageType;
- (id)container;
