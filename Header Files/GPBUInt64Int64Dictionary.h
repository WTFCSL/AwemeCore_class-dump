...
- (id)initWithInt64s:(const long long *)arg0 forKeys:(const unsigned long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndInt64sUsingBlock:(id /* block */)arg0;
- (BOOL)getInt64:(long long *)arg0 forKey:(unsigned long long)arg1;
- (void)setInt64:(long long)arg0 forKey:(unsigned long long)arg1;
- (void)removeInt64ForKey:(unsigned long long)arg0;
