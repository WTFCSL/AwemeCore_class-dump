...
@class AWEECOMIMPageIndicator, NSArray, NSTimer, UICollectionView, NSDate, UIVisualEffectView, NSString;
...
@interface AWEECOMIMBannerView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
    ...
    AWEECOMIMPageIndicator *_carouselIndicator;
    NSTimer *_timer;
    NSDate *_pauseStart;
    ...
    id<AWEECOMIMBannerViewDelegate> _delegate;
