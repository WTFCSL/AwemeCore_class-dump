...
- (BOOL)getInt32:(int *)arg0 forKey:(long long)arg1;
- (BOOL)isEqual:(id)arg0;
- (id)description;
- (void)dealloc;
- (void)addEntriesFromDictionary:(id)arg0;
- (unsigned long long)computeSerializedSizeAsField:(id)arg0;
- (void)setInt32:(int)arg0 forKey:(long long)arg1;
- (void)enumerateForTextFormat:(id /* block */)arg0;
- (id)initWithInt32s:(const int *)arg0 forKeys:(const long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndInt32sUsingBlock:(id /* block */)arg0;
- (void)removeInt32ForKey:(long long)arg0;
