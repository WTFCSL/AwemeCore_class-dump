...
@interface AWEDCardFrequencyIntercepter : NSObject {
    NSArray *_poiIDs;
    NSString *_reason;
    NSMutableDictionary *_freqRulesInMem;
}
...
- (void)setFreqRules:(id)arg0 ofContainer:(long long)arg1;
- (id)freqRulesInMem;
- (id)persistenceKey:(long long)arg0;
- (int)dcardsAcceptionBitsForContainerType:(long long)arg0 rejectReason:(id *)arg1;
- (id)allCardsAcceptResultWithContainerType:(long long)arg0;
- (double)reportBitsRateForType:(long long)arg0;
- (id)freqRulesOfContainerType:(long long)arg0;
- (id)allAcceptBitsRules:(long long)arg0;
- (id)acceptBitsRulesOfContainerType:(long long)arg0 scene:(id)arg1;
- (BOOL)acceptDCardWithScene:(id)arg0 usingFreqControlRules:(id)arg1 usingAcceptBitsRules:(id)arg2 rejectReason:(id *)arg3;
- (id)selectValidStats:(id)arg0 usingFreqStrategy:(id)arg1;
- (BOOL)hitFreqStrategy:(id)arg0 withTargetStats:(id)arg1;
- (BOOL)acceptDCard:(id)arg0 rejectReason:(id *)arg1;
- (id)selectLastNHours:(id)arg0 usingFreqStrategy:(id)arg1;
- (id)selectLastNExposed:(id)arg0 usingFreqStrategy:(id)arg1;
- (id)selectToday:(id)arg0 usingFreqStrategy:(id)arg1;
- (id)selectFromAppLaunch:(id)arg0 usingFreqStrategy:(id)arg1;
- (id)selectLastNMinutes:(id)arg0 usingFreqStrategy:(id)arg1;
- (id)poiIDs;
- (void)updateFreqRules:(id)arg0;
- (void)setFreqRulesInMem:(id)arg0;
- (id)init;
