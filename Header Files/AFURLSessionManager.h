...
- (void)addDelegateForDataTask:(id)arg0 completionHandler:(id /* block */)arg1;
- (void)addDelegateForUploadTask:(id)arg0 progress:(id *)arg1 completionHandler:(id /* block */)arg2;
- (void)addDelegateForDownloadTask:(id)arg0 progress:(id *)arg1 destination:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
...
- (id)uploadTaskWithRequest:(id)arg0 fromFile:(id)arg1 progress:(id *)arg2 completionHandler:(id /* block */)arg3;
- (id)uploadTaskWithRequest:(id)arg0 fromData:(id)arg1 progress:(id *)arg2 completionHandler:(id /* block */)arg3;
- (id)uploadTaskWithStreamedRequest:(id)arg0 progress:(id *)arg1 completionHandler:(id /* block */)arg2;
- (id)downloadTaskWithRequest:(id)arg0 progress:(id *)arg1 destination:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
- (id)downloadTaskWithResumeData:(id)arg0 progress:(id *)arg1 destination:(id /* block */)arg2 completionHandler:(id /* block */)arg3;
