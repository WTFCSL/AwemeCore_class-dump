...
@interface AWEECOMIMSopConfirmCardModel : AWEECOMIMBaseCardModel <AWEECOMIMCardComponentCommonTitleViewProtocol, AWEECOMIMSubCardOrderCardProtocol, AWEECOMIMCardComponentOperationPanelProtocol> {
    NSString *_title;
    NSString *_goodTitle;
    NSString *_goodImg;
    NSString *_goodNum;
...
- (id)goodTitle;
- (id)goodNum;
- (void)excuteSopCardConfirmWithContentDict:(id)arg0;
- (void).cxx_destruct;
