...
@class AWEECOMIMSubCardOrderCard, AWEECOMIMModifyAmountView, AWEECOMIMCardComponentCommonTitleView, AWEECOMIMCardComponentSingleLabelView, AWEECOMIMCardComponentOperationPanel;
...
@interface AWEECOMIMModifyAmountCardView : AWEECOMIMCardBaseView {
    ...
    AWEECOMIMModifyAmountView *_modifyAmountView;
...
@property (retain, nonatomic) AWEECOMIMModifyAmountView *modifyAmountView;
...
- (id)modifyAmountView;
- (void)setModifyAmountView:(id)arg0;
- (void).cxx_destruct;
