...
@interface BDNovelReaderSlider : UIView {
    BOOL _tracking;
    ...
    id<BDNovelReaderSliderDelegate> _delegate;
    double _lineWidth;
...
@property (weak, nonatomic) id<BDNovelReaderSliderDelegate> delegate;
@property (nonatomic) float oldSliderValue;
...
- (void)setOldSliderValue:(float)arg0;
