...
@interface BDPGameInterstitialAdvertisementImplHg : NSObject <BDARVAlertDelegate, BDPGameJumpingView_HGDelegate, BDPPluginGameInterstitialAdvertisementImplProtocol_HG> {
