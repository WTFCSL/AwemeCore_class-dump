...
@class IESLivePKBuilderTimeElapseEntity, NSDictionary, GPBMessage, IESLivePKAudienceBuilder, HTSLiveDoubleInteractionTitleBar, HTSLiveProfitInteractionScoreMessage, IESLivePKInteractUserService, NSString, IESLivePKLogHandler, HTSLivePopupNavigationController, IESLivePKStateManager, HTSEventContext, NSMutableDictionary, NSArray, IESLivePKFeedbackPopUpView, IESLivePKLocalLayout, HTSEventForwardingView, IESLiveInteractiveLinkService, IESLivePKModel, NSSet, IESLiveRevenueInteractPreStreamModel, IESLiveRevenueInteractPlayStateManager, IESLiveRevenueInteractDurationTrackHelper, IESLivePKRivalsRecommendModel, IESLivePKGuestAudiencePlugin, IESLiveInteractiveMediaService, IESLivePKTrackHandler, NSNumber;
...
@interface IESLivePKAudienceFragment : IESLiveRoomComponent <IESLiveRevenueInteractModulePKInterface, IESLivePKProvider, HTSLiveMessageSubscriber, IESLivePKStateAction, IESLiveSocialInteractAction, IESLiveUserActions, IESLiveInteractiveMediaServiceDelegate, IESLiveSocialInteractAction, IESLiveFansGroupActions> {
    BOOL isAnchor;
    ...
    IESLivePKGuestAudiencePlugin *_guestPlugin;
...
- (void)triggerPreStreamActionWith:(BOOL)arg0;
- (void)onComponentUnmountOrDestroy;
- (BOOL)hasTriggerAction;
- (void)triggerOpenGiftPanelAction:(id)arg0;
- (void)setHasTriggerAction:(BOOL)arg0;
- (void)switchSceneWithMediaService:(id)arg0 linkedList:(id)arg1 channelID:(id)arg2 multiRtcInfo:(id)arg3 multiLiveCoreInfo:(id)arg4 intercomConfig:(id)arg5 battleConfig:(id)arg6 extraInfo:(id)arg7;
