...
@interface IESLiveRecoderImp_douyin : NSObject <IESLiveRecoder> {
    id<VERecorderPublicProtocol> _recoder;
    struct { struct CGSize { double width; double height; } outputSize; unsigned long long fps; } _videoConfig;
}
...
+ (id)recorderForLocalPreview:(id)arg0 captureOrientation:(long long)arg1 videoConfig:(struct { struct CGSize { double x0; double x1; } x0; unsigned long long x1; long long x2; })arg2 source:(long long)arg3;
...
- (struct { struct CGSize { double x0; double x1; } x0; unsigned long long x1; })videoConfig;
- (void)setVideoConfig:(struct { struct CGSize { double x0; double x1; } x0; unsigned long long x1; })arg0;
...
- (id)initWithRecoderProtocol:(id)arg0;
- (id)cameraConfigForFastOpenLive;
- (id)cameraConfigForLocalPreview:(id)arg0 captureOrientation:(long long)arg1 videoConfig:(struct { struct CGSize { double x0; double x1; } x0; unsigned long long x1; long long x2; })arg2;
- (id)cameraConfigForNormalOpenLive;
- (void)addRecoderMonitorWithEvent:(id)arg0 source:(id)arg1 extra:(id)arg2;
- (id)init;
- (id)deviceType;
- (void).cxx_destruct;
- (double)exposureBias;
