...
@class NSString, HGUniqueID, HGRevisitEducationView;

@interface HGRevisitEducationViewController : HGBaseAlertViewController {
    BOOL _hasOption;
    ...
    HGRevisitEducationView *_revisitEducationView;
...
@property (retain, nonatomic) HGRevisitEducationView *revisitEducationView;
