...
@protocol ECOMTIMSubConversationModelProtocol;

@interface ECOMTIMOSubConversation : ECOMTIMOModel <ECOMTIMMessageStoreChangesObserver> {
    int _status;
    int _type;
    int _inbox;
    int _appID;
    ...
    id<ECOMTIMSubConversationModelProtocol> _internalModel;
...
@property (retain) id<ECOMTIMSubConversationModelProtocol> internalModel;
