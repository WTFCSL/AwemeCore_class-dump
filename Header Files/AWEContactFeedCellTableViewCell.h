...
@class NSString, AWEAwemeModel, AWEContactFeedListViewController, UIView, UIViewController;
@protocol UIScrollViewDelegate;

@interface AWEContactFeedCellTableViewCell : UITableViewCell <AWEFeedTableViewCellProtocol> {
    long long _indexPath;
    AWEContactFeedListViewController *_viewController;
...
@property (retain, nonatomic) AWEContactFeedListViewController *viewController;
