...
@interface AWECommentSwiftImpl.CommentInputContainerView : UIView <AWECommentListInputViewProtocol, UIGestureRecognizerDelegate> {
    ...
    void /* unknown type, empty encoding */ hideUnexpectedly;
...
- (void)panGestureWithGes:(id)arg0;
- (void)keyboardDidHideWithNotice:(id)arg0;
- (void)keyboardDidShowWithNotice:(id)arg0;
- (void)keyboardWillShowWithNotice:(id)arg0;
- (void)keyboardWillHideWithNotice:(id)arg0;
- (void)keyboardWillChangeFrameWithNotice:(id)arg0;
- (void)dismissKeyboardWithGes:(id)arg0;
