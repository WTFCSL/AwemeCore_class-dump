...
- (void)removeAll;
- (void)setBool:(BOOL)arg0 forKey:(unsigned long long)arg1;
- (id)init;
...
- (id)initWithBools:(const BOOL *)arg0 forKeys:(const unsigned long long *)arg1 count:(unsigned long long)arg2;
- (void)enumerateKeysAndBoolsUsingBlock:(id /* block */)arg0;
- (BOOL)getBool:(BOOL *)arg0 forKey:(unsigned long long)arg1;
- (void)removeBoolForKey:(unsigned long long)arg0;
