...
@class UIView, RTVPageSheetPresentView, UITapGestureRecognizer, NSString, UIControl, RTVPageSheetAccessibilityMaskView, UIPanGestureRecognizer, UIPercentDrivenInteractiveTransition;

@interface RTVPageSheetPresentationController : UIPresentationController <UIGestureRecognizerDelegate> {
    RTVPageSheetAccessibilityMaskView *_closeMaskView;
    ...
    RTVPageSheetPresentView *_internalPresentedView;
}
