...
- (BOOL)needUnfold;
- (void)changeUnfoldOffsetWithOriginY:(double)arg0;
...
- (BOOL)isInMaxExpandAnimation;
- (void)setIsInMaxExpandAnimation:(BOOL)arg0;
- (BOOL)isInCritical;
