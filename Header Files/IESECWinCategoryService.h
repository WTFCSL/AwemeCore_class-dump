...
@interface IESECWinCategoryService : NSObject <IESECWinCategoryService> {
    ...
    BOOL _needShowGuideBubble;
    BOOL _showGuideBubble;
    NSArray *_categoryList;
    NSIndexPath *_selectedIndexPath;
    NSString *_selectedCategoryName;
    NSArray *_subCategoryList;
    NSIndexPath *_selectedSubCategoryIndexPath;
    NSString *_selectedSubCategoryName;
    NSString *_selectedSubCategoryIDs;
    NSString *_selectedCategoryIDs;
