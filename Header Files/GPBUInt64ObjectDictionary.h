...
- (void)removeAll;
- (id)init;
- (void)setObject:(id)arg0 forKey:(unsigned long long)arg1;
- (id)initWithDictionary:(id)arg0;
- (id)copyWithZone:(struct _NSZone { } *)arg0;
- (void)removeObjectForKey:(unsigned long long)arg0;
...
- (id)description;
- (id)objectForKey:(unsigned long long)arg0;
- (void)dealloc;
- (void)addEntriesFromDictionary:(id)arg0;
- (id)initWithObjects:(const id *)arg0 forKeys:(const unsigned long long *)arg1 count:(unsigned long long)arg2;
