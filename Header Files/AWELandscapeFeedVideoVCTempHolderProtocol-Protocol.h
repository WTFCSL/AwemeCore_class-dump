...
@class AWEAwemeModel, NSString, UIImage, UINavigationController, UIView, NSMutableDictionary, AWEBaseListViewController, NSMutableArray, UIViewController;
...
@protocol AWELandscapeFeedVideoVCTempHolderProtocol <NSObject>
